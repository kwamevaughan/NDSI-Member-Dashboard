    ...
    return (
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 shadow-sm border-b ${
          mode === "dark"
            ? "border-[#8DC63F] bg-[#0a0c1d] text-white"
            : "border-gray-300 bg-[#ececec] text-black"
        } ${
          isSidebarOpen ? "md:ml-[250px]" : "md:ml-[80px]"
            ...
            >
              <div className="flex items-center gap-2 cursor-pointer">
                <div className="w-10 h-10 rounded-full overflow-hidden">
                  <Image
                    src={
                      user?.profile_image || "/assets/images/placeholder.png"
                    }
                    alt="User Profile"
                    width={48}
                    height={48}
                ...
                <div className="hidden md:block">
                  ...
                  <span
                    className={`block text-sm font-normal ${
                      mode === "dark" ? "text-[#28A8E0]" : "text-[#28A8E0]"
                    }`}
                  >
                    Member
                  </span>
