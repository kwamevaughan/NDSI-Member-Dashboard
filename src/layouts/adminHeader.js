              ...
              >
                ...
                {newRegistrations > 0 && (
                  <span className="absolute -top-1 -right-1 h-5 w-5 bg-red-500 rounded-full animate-pulse flex items-center justify-center">
                    <span className="text-xs text-white font-bold">{newRegistrations}</span>
                  </span>
                )}
              </button>
                  ...
                  <div className="p-4">
                    {newRegistrations > 0 ? (
                        ...
                        <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                          <div className="flex-shrink-0">
                            <div className="h-8 w-8 rounded-full bg-blue-500 flex items-center justify-center">
                              <Icon icon="mdi:account-plus" className="h-4 w-4 text-white" />
                            </div>
                          </div>
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-blue-700">
                              There has been {newRegistrations} new user registration{newRegistrations !== 1 ? 's' : ''} since your last login
                            </p>
                            <p className="text-xs text-blue-600 mt-1">
                              Click to review pending approvals
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="text-center py-6">
                        <Icon icon="mdi:bell-off" className="h-12 w-12 text-gray-400 mx-auto mb-3" />
