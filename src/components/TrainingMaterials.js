    ...
    return (
        ...
        >
            <div className="flex flex-col justify-between p-8 h-full">  {/* Full height for content */}
                <div className="mb-4">
                    <Icon icon="ri:graduation-cap-fill" className={`text-5xl ${mode === 'dark' ? 'text-sky-400' : 'text-sky-500'}`}/>
                </div>
                <h3 className={`font-bold text-xl mb-4 ${mode === 'dark' ? 'text-white' : 'text-black'}`}>NDSI Training Materials</h3>
